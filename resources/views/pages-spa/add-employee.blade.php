            ...
            <div class="tab-pane active container" id="post-new-job">
                ...
                <div class="tr-single-box">
                    ...
                    <div class="tr-single-body">
                        <form action="{{ route('add-employee') }}" method="POST" enctype="multipart/form-data" novalidate>
                            @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="form-group" data-select2-id="10">
                                    ...
                                    <select id="career-gender" name="gender" class="form-control select2-hidden-accessible"
                            ...
                            <button type="submit" class="btn btn-info btn-md full-width">Thêm mới<i class="ml-2 ti-arrow-right"></i></button>
                        </div>
                        </form>
                    </div>
                </div>
