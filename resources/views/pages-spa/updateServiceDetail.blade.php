        ...
        <div class="tab-pane active container" id="post-new-job">
            ...
            <div class="tr-single-box">
                ...
                <div class="tr-single-body">
                    ...
                    <form action="{{ route('update-serviceDetail', $ser->id) }}" method="POST" enctype="multipart/form-data"
                          novalidate>
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="detail_service"
                                               value="{{$ser->detail_service}}">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group" data-select2-id="10">
                                        ...
                                        <select id="career-gender1" name="service_id"
                                            ...
                                            <option value="" data-select2-id="12">cắt móng</option>
                                ...
                                <div class="col-lg-6 col-md-6col-sm-6" style="width: 150px; ">
                                    <div class="form-group">
                                        @if(!$ser->image_service)
                                        <img id="showImage" src="images/default-avatar.png" width="150"
                                             style="margin-left: 30%;">
                                            @endif
                                            <img id="showImage" src="images/{{$ser->image_service}}" width="150"
                                                 style="margin-left: 30%;">
                                    </div>
                                </div>
