            ...
            <div class="row">
                    ...
                    <div class="sidebar-container d-sm-none d-md-block d-none">
                        ...
                        <div class="sidebar-widget">
                            <div class="form-group">
                                <h5>Địa điểm</h5>
                                <div class="input-with-icon">
                                    <select id="location" name="location" class="js-states form-control select2-hidden-accessible"
                        ...
                        <!-- Category -->
                        <div class="sidebar-widget" >
                            <button type="submit" style="margin-top: 5%" class="btn btn-search full-width btn-info bg-color-purple">Tìm kiếm</button>
                        </div>
                        </form>
                    </div>
                </div>
                <div class="col-md-9">
                    ...
                    <div class="beautypress-single-new-pricing-wraper active">
                        <div class="beautypress-single-new-pricing beautypress-watermark-icon beautypress-pricing-header beautypress-pricing-content">
